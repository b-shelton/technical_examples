...
os.system('aws s3 sync s3://b-shelton-sports /home/ec2-user/tmp --exclude "*" --include "games.gz"')
...
os.system('mkdir /home/ec2-user/tmp')
team_game_stats.to_csv('/home/ec2-user/tmp/team_game_stats.gz', compression = 'gzip', index = None, header = True)
